              ...
              <table className="w-full text-xs table-fixed" style={{ minWidth: 1700 }}>
                ...
                <thead>
                  <tr className="bg-gray-50 text-[10px] uppercase tracking-wider text-gray-500">
                    ...
                    <th className="text-right px-2 py-2 font-medium bg-gray-50 border-l border-gray-200">12-mo</th>
                    <th className="text-right px-2 py-2 font-medium border-l border-gray-200">Short</th>
                  </tr>
                </thead>
                <tbody>
                  {g.rows.map((row) => (
