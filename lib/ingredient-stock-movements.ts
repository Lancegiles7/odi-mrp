...
export async function loadIngredientStockLedger(): Promise<IngStockLedger> {
  ...
  const [
    ...
    supabase.from('ingredients')
      ...
      .eq('is_active', true) as unknown as Promise<{ data: Array<{ id: string; sku_code: string; name: string; unit_of_measure: string | null; supplier_id: string | null; total_loaded_cost: number | null; total_loaded_cost_au: number | null }> | null }>,
