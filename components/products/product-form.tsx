          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field id="manufacture_market" label="Made in">
              ...
              <p className="mt-1 text-[11px] text-gray-400">
                Australia = built in AUD (VMC toll, AU packaging &amp; ingredient costs). The NZD figure is that build converted at FX plus Freight — NZ, i.e. made at VMC and shipped here, so NZD reporting &amp; margin still work.
              </p>
            </Field>
